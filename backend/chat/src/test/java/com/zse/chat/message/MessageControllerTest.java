...
class MessageControllerTest {
  ...
  public void shouldCreateMessage() throws Exception {
    ...
    when(userService.getUserByNick(ArgumentMatchers.any())).thenReturn(user);
    when(messageService.saveMessage(ArgumentMatchers.any(), ArgumentMatchers.any())).thenReturn(message);
  ...
  public void shouldThrowNotFoundUserWhenCreatingMessageForNonExistingUser() throws Exception {
    ...
    when(userService.getUserByNick(ArgumentMatchers.any())).thenThrow(new UserNotFoundException(nick));
  ...
  public void shouldReturnUpdatedMessage() throws Exception {
    ...
    when(messageService.updateMessageById(ArgumentMatchers.eq(id), ArgumentMatchers.any())).thenReturn(message);
  ...
  public void shouldThrowMessageNotFoundWhenTryingUpdateNotExistingMessage() throws Exception {
    ...
    when(messageService.updateMessageById(eq(id), ArgumentMatchers.any()))
